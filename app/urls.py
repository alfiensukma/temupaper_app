...
from .views.search_views import index, get_papers, test_search_process, search_api, recommendation_api
...
urlpatterns = [
    ...
    path('home-recommendation-api/', recommendation_api, name='recommendation_api'),
